...
//    //currentGame = gameId;
//    $.getJSON("/getCardList1")
//            .done(function (data) {
//                showCardsOnTable("#table", data.pImg);
//        console.log("-----> this is data img "+ data.pImg);
//            }).fail(function () {
//        console.log("Not Found");
//    });
//};
//
//function showCardsOnTable(tableId, cards) {// 12 card show on table
...
//};
//
//function checkGameRules(id) {// 3 cards to send set engine 
//    selectedCount++;
...
//                        showCardsOnTable("#setTable",data.setCards);// table id
//                    } else {
